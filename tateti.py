...
def ingresaLetraJugador():
    ...
    # Devuelve una lista con la letra del jugador como primer item, y la de la computadora como segundo.
    letra = ''
...
def jugarDeNuevo():
    # Esta funcion devuelve True si el jugador desea volver a jugar, de lo contrario devuelve False.
